...
public:
    ...
    void setupUi(QWidget *OperationInterface)
    {
        ...
        layoutWidget->setGeometry(QRect(12, -17, 869, 518));
        ...
        gridLayout->addWidget(ShowDataButton, 1, 2, 1, 1);
        ...
        gridLayout->addWidget(labelLoading, 4, 3, 1, 1);
        ...
        gridLayout->addWidget(label_21, 4, 4, 1, 1);
        ...
        gridLayout->addWidget(ComCheckButton, 1, 4, 1, 1);
        ...
        gridLayout->addWidget(sehbeicomboBox, 0, 3, 1, 1);
        ...
        gridLayout->addWidget(IpEdit, 5, 3, 1, 1);
        ...
        gridLayout->addWidget(WriteFilepushButton, 1, 3, 1, 1);
        ...
        gridLayout->addWidget(radioButton, 1, 5, 1, 1);
