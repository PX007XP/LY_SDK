...
public:
    ...
    void setupUi(QWidget *OperationInterface)
    {
        ...
        gridLayout->addWidget(label_21, 1, 10, 1, 1);
        ...
        jianceleibie_comboBox = new QComboBox(groupBox_4);
